		...
		public:
			...
			*/
			static void unittest(void)
				...
				*/
				assert(my_beap.get_height(0) == 0);
				assert(my_beap.get_first(0) == 0);
				assert(my_beap.get_last(0) == 0);

				assert(my_beap.get_height(3) == 2);
				assert(my_beap.get_height(5) == 2);
				assert(my_beap.get_first(2) == 3);
				assert(my_beap.get_last(2) == 5);

				assert(my_beap.get_height(406) == 28);
				assert(my_beap.get_height(434) == 28);
				assert(my_beap.get_first(28) == 406);
				assert(my_beap.get_last(28) == 434);
